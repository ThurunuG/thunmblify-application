                ...
                <div className="flex items-center gap-2">
                    {
                        isLoggedIn ? (
                            <div className="relative group">
                                ...
                                <div onClick={()=>logout()} className="absolute hidden group-hover:block top-6 right-0 pt-4">
                                    <button className="bg-white/20 border-2 border-white/10 px-5 py-1.5 rounded">
                                        Logout
                                    </button>
                                </div>
                            </div>
