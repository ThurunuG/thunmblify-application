...
const thumnailSchema = new mongoose.Schema<IThumbnail>({
    userId: {type: String, ref: 'User', required: true},
    title: {type: String, ref: 'User', trim: true},
...
const Thumbnail = mongoose.models.Thumbnail || mongoose.model<IThumbnail>('Thumbnail', thumnailSchema)
